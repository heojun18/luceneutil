...
public final class Lucene50PostingsReader extends PostingsReaderBase {
  ...
  final class BlockDocsEnum extends PostingsEnum {
    ...
    private void refillDocs() throws IOException {
			...
			//}
			//System.out.println("[arcj] Lucene50PostingsReader::refillDocs-1");
      final int left = docFreq - docUpto;
      assert left > 0;

      if (left >= BLOCK_SIZE) {
				//System.out.println("[arcj] Lucene50PostingsReader::refillDocs::readBlock " + docIn + " / " + encoded + " / " + docDeltaBuffer);
        ...
        if (indexHasFreq) {
          if (needsFreq) {
            ...
            forUtil.skipBlock(docIn); // skip over freqs
				...
				//System.out.println("[arcj] Lucene50PostingsReader::refillDocs::singletonDocID " + singletonDocID);
        docDeltaBuffer[0] = singletonDocID;
        freqBuffer[0] = (int) totalTermFreq;
      } else {
        // Read vInts:
				//System.out.println("[arcj] Lucene50PostingsReader::refillDocs::readVIntBlock " + docDeltaBuffer);
    ...
    public int nextDoc() throws IOException {
			...
			//	System.out.println(ste);
			//}
			//System.out.println("[arcj] Lucene50PostingsReader::nextDoc");
      if (docUpto == docFreq) {
  ...
  final class BlockPostingsEnum extends PostingsEnum {
    ...
    private void refillDocs() throws IOException {
			//System.out.println("[arcj] Lucene50PostingsReader::refillDocs-2");
      final int left = docFreq - docUpto;
      assert left > 0;

      if (left >= BLOCK_SIZE) {
				//System.out.println("[arcj] Lucene50PostingsReader::refillDocs::readBlock2 " + docIn);
        forUtil.readBlock(docIn, encoded, docDeltaBuffer);
        forUtil.readBlock(docIn, encoded, freqBuffer);
      } else if (docFreq == 1) {
				//System.out.println("[arcj] Lucene50PostingsReader::refillDocs::singletonDocID2 " + singletonDocID);
        docDeltaBuffer[0] = singletonDocID;
        freqBuffer[0] = (int) totalTermFreq;
      } else {
        // Read vInts:
				//System.out.println("[arcj] Lucene50PostingsReader::refillDocs::readVIntBlock2 " + docIn );
    ...
    @Override
    public int nextDoc() throws IOException {
			//System.out.println("[arcj] Lucene50PostingsReader::nextDoc2");
      if (docUpto == docFreq) {
        return doc = NO_MORE_DOCS;
      }
      if (docBufferUpto == BLOCK_SIZE) {
  ...
  final class EverythingEnum extends PostingsEnum {
    ...
    private void refillDocs() throws IOException {
			//System.out.println("[arcj] Lucene50PostingsReader::refillDocs-3");
      final int left = docFreq - docUpto;
      assert left > 0;
    ...
    @Override
    public int nextDoc() throws IOException {
			//System.out.println("[arcj] Lucene50PostingsReader::nextDoc3");
      if (docUpto == docFreq) {
        return doc = NO_MORE_DOCS;
      }
      if (docBufferUpto == BLOCK_SIZE) {
  ...
  final class BlockImpactsEverythingEnum extends ImpactsEnum {
    ...
    private void refillDocs() throws IOException {
			//System.out.println("[arcj] Lucene50PostingsReader::refillDocs-4");
      final int left = docFreq - docUpto;
      assert left > 0;
    ...
    @Override
    public int nextDoc() throws IOException {
			//System.out.println("[arcj] Lucene50PostingsReader::nextDoc4");
