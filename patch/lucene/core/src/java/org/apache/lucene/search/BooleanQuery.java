...
public class BooleanQuery extends Query implements Iterable<BooleanClause> {
  ...
  public static class Builder {
    ...
    public Builder add(BooleanClause clause) {
      ...
      //}
      //System.out.println("[arcj] BooleanQuery::add");
    ...
    public BooleanQuery build() {
      ...
      //  System.out.println(ste);
      //}
      //System.out.println("[arcj] BooleanQuery::build");
  ...
  private BooleanQuery(int minimumNumberShouldMatch,
      BooleanClause[] clauses) {
		...
		//	System.out.println(ste);
		//}
		//System.out.println("[arcj] BooleanQuery::BooleanQuery");
  ...
  public Query rewrite(IndexReader reader) throws IOException {
		...
		//	System.out.println(ste);
		//}
		//System.out.println("[arcj] BooleanQuery::rewrite");
		if (clauses.size() == 0) {
    ...
    if (clauses.size() == 1) {
      ...
      Query query = c.getQuery();
			//System.out.println("[arcj] BooleanQuery::rewrite" + query);
    ...
    // recursively rewrite
    {
      ...
      for (BooleanClause clause : this) {
        ...
        Query rewritten = query.rewrite(reader);
				//System.out.println("[arcj] BooleanQuery::rewrite" + query + " / " + rewritten);
        if (rewritten != query) {
    ...
    if (clauseSets.get(Occur.SHOULD).size() > 0 && clauseSets.get(Occur.FILTER).size() > 0) {
			//System.out.println("[arcj] Boolean query");
  ...
  public boolean equals(Object o) {
		...
		//	System.out.println(ste);
		//}
		//System.out.println("[arcj] BooleanQuery::equals");
  ...
  private boolean equalsTo(BooleanQuery other) {
		...
		//	System.out.println(ste);
		//}
		//System.out.println("[arcj] BooleanQuery::equalsTo");
