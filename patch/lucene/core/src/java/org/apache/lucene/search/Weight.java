...
public abstract class Weight implements SegmentCacheable {
  ...
  public Matches matches(LeafReaderContext context, int doc) throws IOException {
		//System.out.println("[arcj] Weight::matches");
  ...
  public BulkScorer bulkScorer(LeafReaderContext context) throws IOException {
		...
		//}
		//System.out.println("[arcj] Weight::bulkScorer");
  ...
  protected static class DefaultBulkScorer extends BulkScorer {
    ...
    public DefaultBulkScorer(Scorer scorer) {
      ...
      this.twoPhase = scorer.twoPhaseIterator();
			//System.out.println("[arcj] Weight::DefaultBulkScorer " + this.iterator + " / " + this.twoPhase);
    }
    ...
    public int score(LeafCollector collector, Bits acceptDocs, int min, int max) throws IOException {
			...
			//	System.out.println(ste);
			//}
			//System.out.println("[arcj] Weight::score " + acceptDocs + " / " + min + " / " + max);
    ...
    static void scoreAll(LeafCollector collector, DocIdSetIterator iterator, TwoPhaseIterator twoPhase, Bits acceptDocs) throws IOException {
			...
			//	System.out.println(ste);
			//}
			//System.out.println("[arcj] Weight::scoreAll " + collector + " / " + iterator + " / " + twoPhase + " / " + acceptDocs + " / " + iterator);
      ...
      if (twoPhase == null) {
        ...
        //for (int doc = iterator.nextDoc(); doc != DocIdSetIterator.NO_MORE_DOCS; doc = iterator.nextDoc()) {
				...
				//	//System.out.println("[arcj] Weight::scoreAll1: " + doc);
        ...
        for (int doc = approximation.nextDoc(); doc != DocIdSetIterator.NO_MORE_DOCS; doc = approximation.nextDoc()) {
					//System.out.println("[arcj] Weight::scoreAll2: " + doc);
          if ((acceptDocs == null || acceptDocs.get(doc)) && twoPhase.matches()) {
			...
			System.out.println("[arcj] scoreAll1: " + timeElapsed1);
			System.out.println("[arcj] scoreAll2: " + timeElapsed2);
			System.out.println("[arcj] scoreAllall: " + timeElapsedAll);
    }
  }
