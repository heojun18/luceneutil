...
final class IndexedDISI extends DocIdSetIterator {
  ...
  public static RandomAccessInput createJumpTable(
      IndexInput slice, long offset, long length, int jumpTableEntryCount) throws IOException {
				System.out.println("[arcj] IndexedDISI::16");
  ...
  @Override
  public int docID() {
				System.out.println("[arcj] IndexedDISI::15");
    return doc;
  }

  @Override
  public int advance(int target) throws IOException {
				System.out.println("[arcj] IndexedDISI::14");
  ...
  public boolean advanceExact(int target) throws IOException {
				System.out.println("[arcj] IndexedDISI::13");
    final int targetBlock = target & 0xFFFF0000;
    if (block < targetBlock) {
      advanceBlock(targetBlock);
    }
  ...
  private void advanceBlock(int targetBlock) throws IOException {
				System.out.println("[arcj] IndexedDISI::12");
  ...
  private void readBlockHeader() throws IOException {
				System.out.println("[arcj] IndexedDISI::11");
  ...
  public int nextDoc() throws IOException {
				System.out.println("[arcj] IndexedDISI::10");
    return advance(doc + 1);
  }

  public int index() {
				System.out.println("[arcj] IndexedDISI::9");
    return index;
  }

  @Override
  public long cost() {
				System.out.println("[arcj] IndexedDISI::8");
    return cost;
  }
  ...
  enum Method {
    SPARSE {
      ...
      boolean advanceWithinBlock(IndexedDISI disi, int target) throws IOException {
				System.out.println("[arcj] IndexedDISI::7");
      ...
      boolean advanceExactWithinBlock(IndexedDISI disi, int target) throws IOException {
				System.out.println("[arcj] IndexedDISI::6");
        final int targetInBlock = target & 0xFFFF;
        // TODO: binary search
        if (target == disi.doc) {
          return disi.exists;
    ...
    DENSE {
      @Override
      boolean advanceWithinBlock(IndexedDISI disi, int target) throws IOException {
				System.out.println("[arcj] IndexedDISI::5");
        final int targetInBlock = target & 0xFFFF;
      ...
      @Override
      boolean advanceExactWithinBlock(IndexedDISI disi, int target) throws IOException {
				System.out.println("[arcj] IndexedDISI::4");
        final int targetInBlock = target & 0xFFFF;
        final int targetWordIndex = targetInBlock >>> 6;
    ...
    ALL {
      ...
      boolean advanceWithinBlock(IndexedDISI disi, int target) {
				System.out.println("[arcj] IndexedDISI::3");
        disi.doc = target;
      ...
      boolean advanceExactWithinBlock(IndexedDISI disi, int target) {
				System.out.println("[arcj] IndexedDISI::2");
        disi.index = target - disi.gap;
        return true;
      }
    };
  ...
  private static void rankSkip(IndexedDISI disi, int targetInBlock) throws IOException {
		System.out.println("[arcj] IndexedDISI::1");
