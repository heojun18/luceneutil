  ...
  public static final DocIdSetIterator empty() {
    return new DocIdSetIterator() {
      ...
      public int advance(int target) {
				...
				//}	
				//System.out.println("[arcj] DocIdSetIterator::advance1: " + target);
        assert !exhausted;
        assert target >= 0;
        exhausted = true;
        return NO_MORE_DOCS;
  ...
  public static final DocIdSetIterator all(int maxDoc) {
    return new DocIdSetIterator() {
      ...
      public int advance(int target) throws IOException {
				...
				//	System.out.println(ste);
				//}	
				//System.out.println("[arcj] DocIdSetIterator::advance2: " + target);
        doc = target;
        if (doc >= maxDoc) {
          doc = NO_MORE_DOCS;
        }
  ...
  public static final DocIdSetIterator range(int minDoc, int maxDoc) {
    ...
    return new DocIdSetIterator() {
      ...
      public int advance(int target) throws IOException {
				...
				//	System.out.println(ste);
				//}	
				//System.out.println("[arcj] DocIdSetIterator::advance3: " + target + " / " + doc + " / " + minDoc + " / " + maxDoc);
