...
public class BM25Similarity extends Similarity {
  ...
  public BM25Similarity(float k1, float b) {
		...
		//}
		//System.out.println("[arcj] BM25Similarity::BM25Similarity");
  ...
  protected float idf(long docFreq, long docCount) {
		...
		//	System.out.println(ste);
		//}
		//System.out.println("[arcj] BM25Similarity::idf");
  ...
  protected float avgFieldLength(CollectionStatistics collectionStats) {
		//System.out.println("[arcj] BM25Similarity::avgFieldLength");
  ...
  public final long computeNorm(FieldInvertState state) {
		//System.out.println("[arcj] BM25Similarity::computeNorm");
    final int numTerms;
  ...
  public Explanation idfExplain(CollectionStatistics collectionStats, TermStatistics termStats) {
		//System.out.println("[arcj] BM25Similarity::idfExplain1");
   ...
   */
  public Explanation idfExplain(CollectionStatistics collectionStats, TermStatistics termStats[]) {
		//System.out.println("[arcj] BM25Similarity::idfExplain2");
  ...
  public final SimScorer scorer(float boost, CollectionStatistics collectionStats, TermStatistics... termStats) {
		...
		//	System.out.println(ste);
		//}
		//System.out.println("[arcj] BM25Similarity::scorer");
  ...
  private static class BM25Scorer extends SimScorer {
    ...
    public float score(float freq, long encodedNorm) {
			...
			//	System.out.println(ste);
			//}
			//System.out.println("[arcj] BM25Similarity::score " + freq + " / " + encodedNorm);
    ...
    public Explanation explain(Explanation freq, long encodedNorm) {
			...
			//	System.out.println(ste);
			//}
			//System.out.println("[arcj] BM25Similarity::explain");
    ...
    private Explanation explainTF(Explanation freq, long norm) {
			//System.out.println("[arcj] BM25Similarity::explainTF");
    ...
    private List<Explanation> explainConstantFactors() {
			//System.out.println("[arcj] BM25Similarity::explainConstantFactors");
      List<Explanation> subs = new ArrayList<>();
      // query boost
      if (boost != 1.0f) {
