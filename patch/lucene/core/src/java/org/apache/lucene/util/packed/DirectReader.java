...
public class DirectReader {
  ...
  public static LongValues getInstance(RandomAccessInput slice, int bitsPerValue) {
		...
		System.out.println("[arcj] DirectReader::getInstance");
  ...
  static final class DirectPackedReader1 extends LongValues {
    ...
    DirectPackedReader1(RandomAccessInput in, long offset) {
			...
			System.out.println("[arcj] DirectReader::DirectPackedReader1");
      this.in = in;
      this.offset = offset;
    }
    ...
    public long get(long index) {
			...
			System.out.println("[arcj] DirectReader::get");
      try {
  ...
  static final class DirectPackedReader2 extends LongValues {
    ...
    DirectPackedReader2(RandomAccessInput in, long offset) {
			...
			System.out.println("[arcj] DirectReader::DirectPackedReader2");
      this.in = in;
      this.offset = offset;
    }
    ...
    public long get(long index) {
			...
			System.out.println("[arcj] DirectReader::get2");
      try {
  ...
  static final class DirectPackedReader4 extends LongValues {
    ...
    DirectPackedReader4(RandomAccessInput in, long offset) {
			...
			System.out.println("[arcj] DirectReader::DirectPackedReader4");
      this.in = in;
      this.offset = offset;
    }
    ...
    public long get(long index) {
			...
			System.out.println("[arcj] DirectReader::get4");
      try {
  ...
  static final class DirectPackedReader8 extends LongValues {
    ...
    public long get(long index) {
			...
			System.out.println("[arcj] DirectReader::get8");
      try {
  ...
  static final class DirectPackedReader12 extends LongValues {
    ...
    DirectPackedReader12(RandomAccessInput in, long offset) {
			...
			System.out.println("[arcj] DirectReader::DirectPackedReader12");
      this.in = in;
      this.offset = offset;
    }
    ...
    public long get(long index) {
			...
			System.out.println("[arcj] DirectReader::get12");
      try {
  ...
  static final class DirectPackedReader16 extends LongValues {
    ...
    public long get(long index) {
			...
			System.out.println("[arcj] DirectReader::get16");
      try {
  ...
  static final class DirectPackedReader20 extends LongValues {
    ...
    DirectPackedReader20(RandomAccessInput in, long offset) {
			...
			System.out.println("[arcj] DirectReader::DirectPackedReader20");
      this.in = in;
      this.offset = offset;
    }
    ...
    public long get(long index) {
			...
			System.out.println("[arcj] DirectReader::get20");
      try {
  ...
  static final class DirectPackedReader24 extends LongValues {
    ...
    public long get(long index) {
			...
			System.out.println("[arcj] DirectReader::get24");
      try {
  ...
  static final class DirectPackedReader28 extends LongValues {
    ...
    DirectPackedReader28(RandomAccessInput in, long offset) {
			...
			System.out.println("[arcj] DirectReader::DirectPackedReader28");
      this.in = in;
      this.offset = offset;
    }
    ...
    public long get(long index) {
			...
			System.out.println("[arcj] DirectReader::get28");
      try {
  ...
  static final class DirectPackedReader32 extends LongValues {
    ...
    DirectPackedReader32(RandomAccessInput in, long offset) {
			...
			System.out.println("[arcj] DirectReader::DirectPackedReader32");
      this.in = in;
      this.offset = offset;
    }
    ...
    public long get(long index) {
			...
			System.out.println("[arcj] DirectReader::get32");
      try {
  ...
  static final class DirectPackedReader40 extends LongValues {
    ...
    DirectPackedReader40(RandomAccessInput in, long offset) {
			...
			System.out.println("[arcj] DirectReader::DirectPackedReader40");
      this.in = in;
      this.offset = offset;
    }
    ...
    public long get(long index) {
			...
			System.out.println("[arcj] DirectReader::get40");
      try {
  ...
  static final class DirectPackedReader48 extends LongValues {
    ...
    DirectPackedReader48(RandomAccessInput in, long offset) {
			...
			System.out.println("[arcj] DirectReader::DirectPackedReader48");
      this.in = in;
      this.offset = offset;
    }
    ...
    public long get(long index) {
			...
			System.out.println("[arcj] DirectReader::get48");
      try {
  ...
  static final class DirectPackedReader56 extends LongValues {
    ...
    DirectPackedReader56(RandomAccessInput in, long offset) {
			...
			System.out.println("[arcj] DirectReader::DirectPackedReader56");
      this.in = in;
      this.offset = offset;
    }
    ...
    public long get(long index) {
			...
			System.out.println("[arcj] DirectReader::get56");
      try {
  ...
  static final class DirectPackedReader64 extends LongValues {
    ...
    DirectPackedReader64(RandomAccessInput in, long offset) {
			...
			System.out.println("[arcj] DirectReader::DirectPackedReader64");
      this.in = in;
      this.offset = offset;
    }
    ...
    public long get(long index) {
			...
			System.out.println("[arcj] DirectReader::get64");
      try {
