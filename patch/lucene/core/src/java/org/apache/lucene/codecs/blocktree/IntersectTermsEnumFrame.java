...
final class IntersectTermsEnumFrame {
  ...
  void loadNextFloorBlock() throws IOException {
      ...
      //}
      //System.out.println("[arcj] IntersectTermsEnumFrame::loadNextFloorBlock");
  ...
  void load(BytesRef frameIndexData) throws IOException {
      ...
      //  System.out.println(ste);
      //}
      //System.out.println("[arcj] IntersectTermsEnumFrame::load");
  ...
  public boolean next() {
      ...
      //  System.out.println(ste);
      //}
      //System.out.println("[arcj] IntersectTermsEnumFrame::next");
    if (isLeafBlock) {
      nextLeaf();
      return false;
    } else {
  ...
  public void nextLeaf() {
      ...
      //  System.out.println(ste);
      //}
      //System.out.println("[arcj] IntersectTermsEnumFrame::nextLeaf");
  ...
  public boolean nextNonLeaf() {
      ...
      //  System.out.println(ste);
      //}
      //System.out.println("[arcj] IntersectTermsEnumFrame::nextNonleaf");
    assert nextEnt != -1 && nextEnt < entCount: "nextEnt=" + nextEnt + " entCount=" + entCount + " fp=" + fp;
    nextEnt++;
  ...
  public int getTermBlockOrd() {
      ...
      //  System.out.println(ste);
      //}
      //System.out.println("[arcj] IntersectTermsEnumFrame::getTermBlockOrd");
  ...
  public void decodeMetaData() throws IOException {
      ...
      //  System.out.println(ste);
      //}
      //System.out.println("[arcj] IntersectTermsEnumFrame::decodeMetadata");
