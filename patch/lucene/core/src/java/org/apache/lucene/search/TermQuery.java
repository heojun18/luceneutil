...
public class TermQuery extends Query {
  ...
  final class TermWeight extends Weight {
    ...
    public TermWeight(IndexSearcher searcher, ScoreMode scoreMode,
      ...
      //}
      //System.out.println("[arcj] TermQuery::TermWeight " + scoreMode + " / " + scoreMode.needsScores());
    ...
    public void extractTerms(Set<Term> terms) {
      //System.out.println("[arcj] TermQuery::extractTerms");
      terms.add(getTerm());
    }

    @Override
    public Matches matches(LeafReaderContext context, int doc) throws IOException {
      //System.out.println("[arcj] TermQuery::matches");
    ...
    public Scorer scorer(LeafReaderContext context) throws IOException {
      ...
      //  System.out.println(ste);
      //}
      //System.out.println("[arcj] TermQuery::scorer");
    ...
    private TermsEnum getTermsEnum(LeafReaderContext context) throws IOException {
      //System.out.println("[arcj] TermQuery:getTermsEnum");
    ...
    public Explanation explain(LeafReaderContext context, int doc) throws IOException {
      //System.out.println("[arcj] TermQuery::explain");
  ...
  public Weight createWeight(IndexSearcher searcher, ScoreMode scoreMode, float boost) throws IOException {
		...
		//	System.out.println(ste);
		//}
		//System.out.println("[arcj] TermQuery::createWight");
